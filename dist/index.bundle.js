...
/***/ "./src/js/apiCreateDisplay.js":
/*!************************************!*\
  !*** ./src/js/apiCreateDisplay.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ApiIntegration)\n/* harmony export */ });\n/* harmony import */ var _display_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display.js */ \"./src/js/display.js\");\n\r\n\r\nconst url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/nohPq9IytVOevijVm84e/scores/'\r\nclass ApiIntegration{\r\n    static createGame = () => {\r\n        const game = {\r\n            name:'Call Of Duty'\r\n        }\r\n        fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games', {\r\n            method:'POST',\r\n            body:JSON.stringify(game),\r\n            headers: {\r\n                'Content-type': 'application/json; charset= UTF-8',\r\n            }\r\n        })\r\n    }\r\n\r\n    static refreshGame = (players,leaderboard) => {\r\n        fetch(url).then(respone => respone.json()).then(json => {\r\n            players= json.result,\r\n            _display_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].displayScores(players,leaderboard)\r\n        })\r\n    }\r\n\r\n    static addData = async (data) => {\r\n        const res = await fetch(url, {\r\n            method: 'POST',\r\n            body: JSON.stringify(data),\r\n            headers: {\r\n                'Content-type': 'application/json; charset= UTF-8',\r\n            }\r\n        })\r\n\r\n        const {result} = await res.json();\r\n        return result\r\n    }\r\n}\n\n//# sourceURL=webpack://leaderboard/./src/js/apiCreateDisplay.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Display)\n/* harmony export */ });\nclass Display {\r\n    static displayScores = (player, display) => {\r\n        const scores = player.sort((firstIndex,secondIndex) => \r\n            parseFloat(secondIndex.score) - parseFloat(firstIndex.score)\r\n        )\r\n\r\n        display.innerHTML = ''\r\n        scores.forEach(element => {\r\n            display.innerHTML += `<span class=\"score\">${element.user}: ${element.score}</span>`\r\n        });\r\n    }\r\n}\n\n//# sourceURL=webpack://leaderboard/./src/js/display.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.css */ \"./src/index.css\");\n/* harmony import */ var _apiCreateDisplay_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./apiCreateDisplay.js */ \"./src/js/apiCreateDisplay.js\");\n\r\n\r\n\r\nconst scoreTable = document.querySelector('#sores-table')\r\nconst refreshButton = document.querySelector('#refresh-btn')\r\nconst form = document.querySelector('form')\r\nconst playerName = document.getElementById('playerName')\r\nconst playerScore = document.getElementById('playerScore')\r\n\r\nconsole.log(playerName)\r\nconsole.log(playerScore)\r\n\r\nlet players;\r\n\r\n_apiCreateDisplay_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].refreshGame(players,scoreTable)\r\n\r\nrefreshButton.addEventListener('click', () => {\r\n    _apiCreateDisplay_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].refreshGame(players,scoreTable)\r\n})\r\n\r\nform.addEventListener('click', async (e) => {\r\n    e.preventDefault()\r\n    const playerScores = {\r\n        user:playerName,\r\n        score:playerScore\r\n    }\r\n\r\n    \r\n    await _apiCreateDisplay_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addData(playerScores)\r\n    form.reset()\r\n})\n\n//# sourceURL=webpack://leaderboard/./src/js/index.js?");
